...
class WikifabFooter extends Component {
	...
	public function getHtml() {
		...
		$ret = '
					Une association à but non lucratif gérée avec <span class="glyphicon glyphicon-heart" style="color:red" aria-hidden="true"></span> par un petit groupe de passionnés basés à Paris.
		';
		return $ret;
