...
class NewTutoBar extends Component {
	...
	public function getHtml() {
		global $wgExploreIsLocalized, $wgNewTutoFormName;
		...
		if (isset($wgNewTutoFormName)) {
			$newTutoPageTitle = \Title::makeTitle( SF_NS_FORM, $wgNewTutoFormName);
		} else if ($wgExploreIsLocalized) {
